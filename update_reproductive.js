...
const newPathologies = [
    {
        ...
        "details": {
            ...
            "symptomes": [
                "Écoulements anormaux (pertes vaginales, urétrales)",
                "Lésions cutanées (ulcères, verrues, vésicules)",
                "Douleurs pelviennes",
                "Asymptomatique (très fréquent)"
            ],
            "dépistage": [
                "Prélèvements locaux (écouvillon)",
                "Analyses d'urine",
                "Prélèvements sanguins (sérologies)"
            ],
            "prévention": [
                "Port du préservatif",
                "Vaccination (VPH, Hépatite B)",
                "Dépistage régulier et traitement des partenaires"
            ]
        }
    },
    {
        ...
        "details": {
            ...
            "symptomes": [
                ...
                "Dysménorrhée intense (règles douloureuses)",
    ...
    },
    {
        ...
        "details": {
            ...
            "symptomes": [
                "Souvent aucun au début",
                "Saignements après les rapports",
                "Pertes vaginales inhabituelles"
            ],
            "prévention": [
                "Vaccination VPH",
                "Suivi régulier (dépistage)"
            ]
        }
    },
    {
    ...
    },
    {
        ...
        "details": {
            "symptomes": [
                "Vagues ballonnements abdominaux",
    ...
    },
    {
        ...
        "details": {
            "symptomes": [
                "Jet urinaire faible ou saccadé",
                "Difficulté à débuter la miction",
                "Nicturie (lever la nuit)",
    ...
    },
    {
        ...
        "details": {
            ...
            "symptomes": [
                "Peuvent être identiques à l'HBP",
            ...
            "traitements": [
                ...
                "Hormonothérapie (privation ischémique)"
            ]
        }
    }
];
...
const newInterventions = [
    {
        ...
        "details": {
            "types": [
                "Totale: Utérus et col",
                "Subtotale: Corps de l'utérus uniquement",
                "Avec salpingo-ovariectomie: Trompes et ovaires (ménaopause induite)"
            ],
            "soins_post_op": [
                "Surveillance des saignements (serviettes périnéales)",
                "Reprise précoce de la marche (prévention TVP)",
                "Soutien émotionnel (perte de fertilité/féminité)"
            ]
        }
    },
    {
        ...
        "details": {
            "soins_post_op": [
                "Élévation du bras du côté opéré",
                "PAS de prises de TA ou ponctions sur le bras opéré (risque lymphoedème)",
                "Exercices graduels du bras",
    ...
    },
    {
        ...
        "category": "interventions",
        "preview": "Ablation de la tumeur mammaire avec une marge de tissu sain conservant le sein.",
        "details": {
            "description": "Souvent complétée par une radiothérapie.",
            "soins": [
                "Surveillance de l'incision",
                "Soutien gorge de maintien post-opératoire"
            ]
        }
    },
    {
        ...
        "details": {
            "soins_post_op": [
                "Irrigation vésicale continue (3-voies) pour prévenir les caillots",
                "Calcul de la diurèse réelle (déduire le soluté d'irrigation)",
                "Surveillance de la couleur de l'urine (hématurie)"
            ],
    ...
    },
    {
        ...
        "details": {
            "post_op": [
                "Sonde urinaire prolongée (1-2 semaines)",
                "Risque d'incontinence et de dysfonction érectile",
...
function updateJson(filePath, newItems) {
...
updateJson('pathologies.json', newPathologies);
updateJson('interventions.json', newInterventions);
